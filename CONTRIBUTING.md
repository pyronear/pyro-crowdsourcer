...
Whether you encountered a problem, or you have a feature suggestion, your input has value and can be used by contributors to reference it in their developments. For this purpose, we advise you to use Github [issues](https://github.com/pyronear/pyro-crowdsourcer/issues). 

First, check whether the topic wasn't already covered in an open / closed issue. If not, feel free to open a new one! When doing so, use issue templates whenever possible and provide enough information for other contributors to jump in.

### Questions

If you are wondering how to do something with the project, or a more general question, you should consider checking out Github [discussions](https://github.com/pyronear/pyro-crowdsourcer/discussions). See it as a Q&A forum, or the Pyronear-specific StackOverflow!
...
1 - Fork this [repository](https://github.com/pyronear/pyro-crowdsourcer) by clicking on the "Fork" button at the top right of the page. This will create a copy of the project under your GitHub account (cf. [Fork a repo](https://docs.github.com/en/get-started/quickstart/fork-a-repo)).
...
```shell
git clone git@github.com:<YOUR_GITHUB_ACCOUNT>/pyro-crowdsourcer.git
cd pyro-crowdsourcer
git remote add upstream https://github.com/pyronear/pyro-crowdsourcer.git
```
...
4 - You only have to set your development environment now, you can install the correct dependencies:
```shell
